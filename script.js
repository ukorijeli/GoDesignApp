...
                    window.location.href = `https://godesign-api.onrender.com/api/export-all/${userToFetch}`;
...
                const response = await fetch('https://godesign-api.onrender.com/api/tasks', {
...
            const response = await fetch(`https://godesign-api.onrender.com/api/tasks/${userToFetch}`);
...
        const url = `https://godesign-api.onrender.com/api/costs/summary?v=${new Date().getTime()}`;
