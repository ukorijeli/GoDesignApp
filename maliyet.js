...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (exportButton) {
        exportButton.addEventListener('click', () => {
            ...
            window.location.href = `https://godesign-api.onrender.com/api/costs/export?customer=${encodeURIComponent(userForFilename)}`;
        });
    }
    ...
    async function loadCostData() {
        ...
        try {
            const response = await fetch('https://godesign-api.onrender.com/api/costs');
