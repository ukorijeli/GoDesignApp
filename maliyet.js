...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (exportButton) {
        exportButton.addEventListener('click', () => {
            ...
            window.location.href = `https://ac5e2745f52a.ngrok-free.app:5000/api/costs/export?customer=${encodeURIComponent(userForFilename)}`;
        });
    }
    ...
    async function loadCostData() {
        ...
        try {
            const response = await fetch('https://ac5e2745f52a.ngrok-free.app:5000/api/costs');
